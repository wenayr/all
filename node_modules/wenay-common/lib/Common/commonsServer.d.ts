...
export declare function CreatAPIFacadeClient<T extends object>({ socketKey, socket, limit }: {
    socket: tSocket;
    socketKey: string;
    limit?: number;
}): {
...
export declare function CreatAPIFacadeServer<T extends object>({ object, socket, socketKey, debug }: {
    socket: tSocket;
    object: T;
    socketKey: string;
    debug?: boolean;
